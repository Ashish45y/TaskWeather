package dev.ashish.taskweather.activity
...
import dev.ashish.taskweather.R
import dev.ashish.taskweather.databinding.TaskweatherActivityMainBinding
import dev.ashish.taskweather.models.WeatherModel
import dev.ashish.taskweather.utilities.ApiUtil
...
class TaskWeatherActivity : AppCompatActivity() {
     private lateinit var binding : TaskweatherActivityMainBinding
    private lateinit var currentLocation: Location
    private lateinit var fusedLocationProvider: FusedLocationProviderClient
    private val LOCATION_REQUEST_CODE = 101
    private val apiKey = "87c3df824e31192e0e47e30f177fe37c"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.taskweather_activity_main)
    ...
    private fun getCityWeather(city: String) {
        ...
        ApiUtil.getApiInterface()?.getCityWeatherData(city,apiKey)
            ?.enqueue(object :Callback<WeatherModel>{
                ...
                override fun onResponse(call: Call<WeatherModel>, response: Response<WeatherModel>) {
                    if (response.isSuccessful){
                        ...
                        Toast.makeText(this@TaskWeatherActivity, "No City Found",
    ...
    private fun setData(body:WeatherModel){
        ...
        binding.apply {
            ...
            groundValue.text=body.main.ground_level.toString()
            ...
            when (id) {
                ...
                in 200..232 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.thunderstrom_bg)
                ...
                in 300..321 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.drizzle_bg)
                ...
                in 500..531 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.rain_bg)
                ...
                in 600..622 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.snow_bg)
                ...
                in 701..781 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.atmosphere_bg)
                ...
                800 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.clear_bg)
                ...
                in 801..804 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.clouds_bg)
                ...
                //unknown
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@TaskWeatherActivity, R.drawable.unknown_bg)
